<nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
    <div class="row w-100 m-0 p-0">
        <a class="navbar-brand p-0 col-12 m-0 col-sm-10 col-md-4" href="{{ url('/') }}">
{{--            <div class="row m-0">{{ config('app.name') }}</div>--}}
        ...
        <button class="navbar-toggler col-12 col-sm-2 collapsed" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
